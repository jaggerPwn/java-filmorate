...
CREATE TABLE IF NOT EXISTS PUBLIC.FRIENDS (
	...
	CONSTRAINT FRIENDS_PK1 PRIMARY KEY (USER_ID,USER_ID),
...
CREATE TABLE IF NOT EXISTS PUBLIC.MPA_FILM (
	...
	FILM_ID INTEGER NOT NULL,
	CONSTRAINT MPA_FILM_FK FOREIGN KEY (MPA_ID) REFERENCES PUBLIC.MPA(MPA_ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT MPA_FILM_FK2 FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(FILM_ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
